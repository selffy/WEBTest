...
<%
	...
	List registerDateList= new java.util.ArrayList();
	...
	try {
		...
		if (lastMsgId == 0) {
			...
			while(rs.next()) {
				...
				registerDateList.add(rs.getString("REGISTER_DATE"));
...
<result>
	...
	<register_date><![CDATA[<%=(String)registerDateList.get(i)%>]]></register_date>
	<%	} %>
	</messages>
	<%	} %>
</result>